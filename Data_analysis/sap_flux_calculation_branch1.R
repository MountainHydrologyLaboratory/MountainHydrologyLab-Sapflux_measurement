...
inmat<- as.matrix(read.csv("ot7.csv", header=FALSE)[5:41000,6:23]) #reads datafile
...
vwd<-0.8 #volume fraction of wood
vwt<-0.2 #volume fraction of water
error<- -9999
...
write.csv(stvar,"stvarmc8_v1.csv")
